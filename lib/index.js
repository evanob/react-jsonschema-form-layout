...
var GridField = function (_ObjectField) {
  ...
  function GridField() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = GridField.__proto__ || Object.getPrototypeOf(GridField)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _temp), _possibleConstructorReturn(_this, _ret);
  }
